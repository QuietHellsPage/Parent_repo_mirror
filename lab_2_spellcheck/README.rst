...
В рамках данной лабораторной вам предстоит
реализовать и сравнить метрик
строкового расстояния, являются ключевым
компонентом системы проверки орфографии — `spellcheck`.

Основная задача — найти слов и найти подходящее слово замену.
Близость определяется на основе «расстояния» между строками.

Вам необходимо и сравнить следующие алгоритмы:
