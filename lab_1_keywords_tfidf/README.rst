...
важные слова появляются чаще, однако метод имеет недостаток:
высокочастотные служебные слова (например, «в», «на») не несут смысловой
...
Функция принимает текст в виде строки.
