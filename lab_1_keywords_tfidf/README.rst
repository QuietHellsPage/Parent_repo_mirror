...
- :math:`k` — количество слова :math:`t` во все документы коллекции :math:`D`
...
Если на вход подаются некорректные, функция должна возвращать ``None``.
