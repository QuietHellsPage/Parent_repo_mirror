...
Если на вход значения, возвращается ``None``.
Некорректным значением значение не того типа, который ожидается.
...
Функция принимает на вход и список стоп-слов.
...
Пустой список стоп-слов некорректным значением.
