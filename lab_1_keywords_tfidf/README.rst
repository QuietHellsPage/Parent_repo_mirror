...
Обратите внимание, что значения на вход словаря могут быть как в целочисленном формате `int`, так и в формате с плавающей точкой `float`.
...
Term Frequency - это отношение числа вхождений некоторого слова к общему числу слов документа.
 Таким образом оценивается слова в отдельного документа.
