...
и обратно пропорционален вхождений в остальные документы.
Простыми словами: чем чаще в нашем документе и чем оно встречается где-то ещё, тем оно важнее.

.. note::

   Если слово не найдено в формулу выше,
...
Функция принимает: словарь со значениями TF и словарь со значениями IDF.
