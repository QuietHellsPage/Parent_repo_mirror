...
- :math:`l` — количество всех слов, кроме :math:`t`, в документ :math:`d`
...
- ``observed`` — наблюдаемое вхождений слова в документе
...
Выведите 10 важных слов с точки зрения статистики.
