...
Современные методы обработки информации требуют выделения наиболее
значимых слов и выражений, которые отражают суть документа. Такой процесс называется извлечением
ключевых слов и является важным в задачах информационного поиска, аннотирования
...
высокочастотные служебные (например, «и», «в», «на») не несут смысловой
нагрузки, но доминируют в тест.
