...
Таким образом, вес токена пропорционален количеству его вхождений в этот документ
...
Функция принимает на вход два: словарь со значениями TF и словарь со значениями IDF.
