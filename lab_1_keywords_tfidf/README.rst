...
Таким образом, вес в документе прямо пропорционален количеству его вхождений в этот документ
и обратно пропорционален количеству вхождений в остальные документы.
Простыми словами: чем чаще в нашем оно встречается где-то ещё, тем оно важнее.
